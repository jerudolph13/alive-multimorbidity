...
packages <- c("tidyverse", "data.table", "RColorBrewer", "zoo", "ggpubr", "gmodels")
...
multimorbid0719 <- read_csv(file="../data/alive_comorbid_imputed.csv") %>% 
  mutate(gt2 = as.numeric(n_cond>=2),
         gt3 = as.numeric(n_cond>=3))


# Counts and proportions --------------------------------------------------

CrossTable(multimorbid0719$yr, multimorbid0719$gt2)
CrossTable(multimorbid0719$yr, multimorbid0719$gt3)


# Distribution overall ----------------------------------------------------

# Distribution across all calendar years
ggplot(data=multimorbid0719, aes(x=n_cond)) + thm2 +
...
jpeg(file="../figures/multi6_n_imputed.jpg", height=5, width=8, units="in", res=300)  
ggplot(data=multimorbid0719, aes(fill=as.factor(n_cond), x=yr)) + thm1 +
...
jpeg(file="../figures/multi6_prop_imputed.jpg", height=5, width=8, units="in", res=300)  
ggplot(data=multimorbid0719, aes(fill=as.factor(n_cond), x=yr)) + thm1 +
  labs(title="Prevelance of Multimorbidity in ALIVE, 2007-2019",
...
p1 <- ggplot(data=filter(multimorbid0719, hiv==1), aes(fill=as.factor(n_cond), x=yr)) + thm1 +
...
p2 <- ggplot(data=filter(multimorbid0719, hiv==0), aes(fill=as.factor(n_cond), x=yr)) + thm1 +
...
ggplot(data=filter(multimorbid0719, age_cat=="<40"), aes(fill=as.factor(n_cond), x=yr)) + thm1 +
  labs(y="Proportion of Participants\n", x="\nYear", fill="Number of Comorbidities") +
  geom_bar(position="fill") +
  scale_y_continuous(expand=c(0,0)) +
  scale_x_continuous(breaks=seq(2007, 2019, 1)) +
...
ggplot(data=filter(multimorbid0719, age_cat=="40-49"), aes(fill=as.factor(n_cond), x=yr)) + thm1 +
  labs(y="Proportion of Participants\n", x="\nYear", fill="Number of Comorbidities") +
  geom_bar(position="fill") +
  scale_y_continuous(expand=c(0,0)) +
  scale_x_continuous(breaks=seq(2007, 2019, 1)) +
...
ggplot(data=filter(multimorbid0719, age_cat=="50-59"), aes(fill=as.factor(n_cond), x=yr)) + thm1 +
  labs(y="Proportion of Participants\n", x="\nYear", fill="Number of Comorbidities") +
  geom_bar(position="fill") +
  scale_y_continuous(expand=c(0,0)) +
  scale_x_continuous(breaks=seq(2007, 2019, 1)) +
...
ggplot(data=filter(multimorbid0719, age_cat=="60-69"), aes(fill=as.factor(n_cond), x=yr)) + thm1 +
  labs(y="Proportion of Participants\n", x="\nYear", fill="Number of Comorbidities") +
  geom_bar(position="fill") +
  scale_y_continuous(expand=c(0,0)) +
  scale_x_continuous(breaks=seq(2007, 2019, 1)) +
...
ggplot(data=filter(multimorbid0719, age_cat=="70+"), aes(fill=as.factor(n_cond), x=yr)) + thm1 +
  labs(y="Proportion of Participants\n", x="\nYear", fill="Number of Comorbidities") +
  geom_bar(position="fill") +
  scale_y_continuous(expand=c(0,0)) +
  scale_x_continuous(breaks=seq(2007, 2019, 1)) +
