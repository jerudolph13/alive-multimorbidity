...
# Control for BMI outliers by capping at the 99th percentile
#   p99 <- quantile(comorbid_annual$bmimedh, probs=0.99, na.rm=T)
# comorbid_annual <- comorbid_annual %>% 
#   mutate(bmimedh = ifelse(bmimedh>p99, p99, bmimedh))
...
write_csv(bmi, file="./alive_bmi_impute.csv")
